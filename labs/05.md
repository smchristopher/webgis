...
- zoom the map view to TAMU Campus with an appropriate zoom level
- add external [TAMU Building](http://gisday.tamu.edu/Rest/Buildings/Map/Get/) GeoJSON into your Map  
- change your building color to "Maroon" or any color you like. 
- make the buildings highlighted visually in some way when they are hovered with a mouse
- define a click listener that zooms to the building
- custom a Info Control to show the buidling's name and abbr when they are hovered with a mouse

>
![Sample_Result](../images/labs/05/final.PNG)
>
*sample Result*

# **To Hand In:**
1. Create a lab\05\ folder in your Github repository and link it to your main README.md
2. Upload 3 html files (one for each tutorial and one for custom web map) to your lab\05\ folder
3. Open the **Custom_Map.html** you created in a browser and take a screenshot of your custom map and upload it to your lab\05\ folder
4. Submit the link to your Github lab\05\ folder 
